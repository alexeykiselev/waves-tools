...
def check_asset_distribution():
    ...
    if distribution:
        ...
        print('Quantity\t: {:<24,.8f}'.format(arrange(quantity, decimals)))
        ...
        print()
        print('Total                                    {:24,.8f}'.format(arrange(total, decimals)))
        print('Quantity                                 {:24,.8f}'.format(arrange(quantity, decimals)))
        diff = quantity - total
        print('Difference                               {:24,.8f}'.format(arrange(diff, decimals)))
        print()
        if diff != 0:
            print('ERROR!!!')
        else:
